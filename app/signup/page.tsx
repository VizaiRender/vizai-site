    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <h1 style={{
            fontSize: "clamp(2.25rem, 8vw, 4.5rem)", fontWeight: 700, color: "#fff",
            letterSpacing: "-0.02em", lineHeight: 1.1, margin: 0,
          }}>
            {t.auth.signup.title}
          </h1>
          <p style={{
            fontSize: "clamp(1rem, 3vw, 1.75rem)", fontWeight: 300,
        ...
        <div style={{ width: "100%" }}>
          ...
          >
            ...
            {loading ? t.auth.signup.redirecting : t.auth.signup.button}
          </button>
        </div>
