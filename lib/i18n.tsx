...
const pt = {
  ...
  home: {
    ...
    heroFree: "Grátis ·",
    heroCredits: "8 créditos para testar, sem cartão",
  ...
  tools: {
    ...
    items: [
      ...
      { name: "Reflexo de Espelho", description: "Gere reflexos realistas em espelho, vidro de armário, TV desligada e piso polido, coerentes com a cena, antes de renderizar." },
  ...
  midCta: {
    ...
    note: "Grátis · 8 créditos para testar, sem cartão",
  },
  cta: {
  ...
  footer: {
    plans: "Planos",
    tagline:
      "O Vizai Render é um plugin de renderização com IA que funciona diretamente na viewport do seu SketchUp.",
    colProduct: "Produto",
    colTraining: "Treinamento",
    colGuides: "Guias",
    allLessons: "Todas as aulas",
    lessonRender: "Primeiro render",
    lessonMirror: "Reflexo e Luz Fake",
    firstSteps: "Primeiros passos",
    decorate: "Decorar Ambiente",
    floorPlan: "Planta Humanizada",
    diagram: "Diagrama",
    moodboard: "Moodboard",
  ...
  download: {
    ...
    tabs: {
      ...
      reqSketchupBody: "Versão 2023 ou superior",
...
const en: Dict = {
  ...
  home: {
    ...
    heroFree: "Free ·",
    heroCredits: "8 credits to try, no card",
  ...
  tools: {
    ...
    items: [
      ...
      { name: "Mirror Reflection", description: "Generate realistic reflections on mirrors, cabinet glass, switched-off TVs and polished floors, consistent with the scene, before rendering." },
  ...
  midCta: {
    ...
    note: "Free · 8 credits to try, no card",
  },
  cta: {
  ...
  footer: {
    plans: "Plans",
    tagline:
      "Vizai Render is an AI rendering plugin that works right inside your SketchUp viewport.",
    colProduct: "Product",
    colTraining: "Training",
    colGuides: "Guides",
    allLessons: "All lessons",
    lessonRender: "First render",
    lessonMirror: "Reflections and Fake Light",
    firstSteps: "First steps",
    decorate: "Decorate Room",
    floorPlan: "Rendered Floor Plan",
    diagram: "Diagram",
    moodboard: "Moodboard",
    download: "How to install",
    training: "Training",
  ...
  download: {
    ...
    tabs: {
      ...
      reqSketchupTitle: "SketchUp",
      reqSketchupBody: "Version 2023 or higher",
...
const es: Dict = {
  ...
  home: {
    ...
    heroFree: "Gratis ·",
    heroCredits: "8 créditos para probar, sin tarjeta",
  ...
  tools: {
    ...
    items: [
      ...
      { name: "Reflejo de Espejo", description: "Genera reflejos realistas en espejo, vidrio de armario, TV apagada y suelo pulido, coherentes con la escena, antes de renderizar." },
  ...
  midCta: {
    ...
    note: "Gratis · 8 créditos para probar, sin tarjeta",
  },
  cta: {
  ...
  footer: {
    plans: "Planes",
    tagline:
      "Vizai Render es un plugin de renderizado con IA que funciona directamente en la viewport de tu SketchUp.",
    colProduct: "Producto",
    colTraining: "Entrenamiento",
    colGuides: "Guías",
    allLessons: "Todas las clases",
    lessonRender: "Primer render",
    lessonMirror: "Reflejo y Luz Fake",
    firstSteps: "Primeros pasos",
    decorate: "Decorar Ambiente",
    floorPlan: "Plano Humanizado",
    diagram: "Diagrama",
    moodboard: "Moodboard",
    download: "Cómo instalar",
  ...
  download: {
    ...
    tabs: {
      ...
      reqSketchupTitle: "SketchUp",
      reqSketchupBody: "Versión 2023 o superior",
