  ...
  "como-funciona-creditos": {
    ...
    blocks: [
      ...
      },
      {
        type: "ul",
        items: [
          "**Monthly plans** — Starter (250 credits/month), Pro (650 credits/month) and Business (1,750 credits/month). Credits renew every month and you can cancel anytime.",
  ...
  "panorama-360": {
    ...
    blocks: [
      ...
      { type: "h2", text: "How to generate" },
      {
        ...
        caption: "The 360 tab: upload 4 renders from the same central point.",
        ui: true,
      },
      {
        type: "p",
        text: "Render **4 views from the same central point** — front, right, back and left, in 16:9 or 1:1 — and load each one into its matching slot. The AI stitches the four into a continuous spherical panorama of the space.",
      },
      {
        type: "steps",
        items: [
          {
            ...
            text: "Eye height (~1.60m) and the same point for all 4 views.",
          },
          {
            title: "Render and upload the 4 views",
            text: "Front, right, back and left (16:9 or 1:1), each one into its matching slot.",
          },
          {
            title: "Generate the 360",
            text: "5 credits. The AI stitches the 4 views into a continuous spherical panorama.",
          },
          {
            title: "Share",
