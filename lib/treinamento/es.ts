  ...
  "como-funciona-creditos": {
    ...
    blocks: [
      ...
      },
      {
        type: "ul",
        items: [
          "**Planes mensuales** — Starter (250 créditos/mes), Pro (600 créditos/mes) y Business (1.750 créditos/mes). Los créditos se renuevan cada mes y puedes cancelar cuando quieras.",
