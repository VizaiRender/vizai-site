  ...
  "como-funciona-creditos": {
    ...
    blocks: [
      ...
      },
      {
        type: "ul",
        items: [
          "**Planos mensais** — Starter (250 créditos/mês), Pro (600 créditos/mês) e Business (1.750 créditos/mês). Os créditos renovam todo mês e você pode cancelar quando quiser.",
