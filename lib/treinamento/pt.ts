  ...
  "como-funciona-creditos": {
    ...
    blocks: [
      ...
      },
      {
        type: "ul",
        items: [
          "**Planos mensais** — Starter (300 créditos/mês), Pro (750 créditos/mês) e Business (2.000 créditos/mês). Os créditos renovam todo mês e você pode cancelar quando quiser.",
