...
export const TypewriterEffectSmooth = ({
  ...
  return (
    <div className={cn("flex space-x-1 my-2 sm:my-6", className)}>
      <motion.div
      ...
      >
        <div className="text-3xl sm:text-base md:text-xl lg:text-3xl xl:text-5xl font-bold" style={{ whiteSpace: "nowrap" }}>
          {wordsArray.map((word, idx) => (
            <div key={`word-${idx}`} className="inline-block">
              {word.text.map((char, index) => (
