// Bandeiras compartilhadas (navbar + seção de compatibilidade).
export type FlagLang = "pt" | "en" | "es";
...
export function Flag({ lang, className = "w-6 h-6" }: { lang: FlagLang; className?: string }) {
