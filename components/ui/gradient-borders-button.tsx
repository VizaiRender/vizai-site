...
export default function GradientBordersButton({
  ...
  const additionalProps = href ? { href } : { type: 'button' as const };
  ...
  return (
    ...
    >
      <span className='absolute inset-0 overflow-hidden rounded-full'>
        <span className='absolute inset-0 rounded-full bg-[radial-gradient(75%_100%_at_50%_0%,rgba(9,64,210,1)_0%,rgba(56,189,248,1)_75%)] opacity-40 transition-opacity duration-500 group-hover:opacity-100 dark:bg-[radial-gradient(75%_100%_at_50%_0%,rgba(9,64,210,0.8)_0%,rgba(56,189,248,0.4)_75%)] dark:opacity-0' />
      </span>
      ...
      <span className='absolute bottom-0 left-4.5 h-px w-[calc(100%-2.25rem)] bg-gradient-to-r from-[#0940D2]/0 via-[#0940D2]/90 to-[#0940D2]/0 transition-opacity duration-500 group-hover:opacity-40' />
    </Component>
  )
}
